...
export function registerMicroApps(apps, lifeCycles) {
  ...
  // _toConsumableArray()尽可能的把参数转成一个数组
  ...
  unregisteredApps.forEach(function (app) {
    var name = app.name,
        ...
        props = app.props,
        // __rest 返回app中除了 name, activeRule, loader, props 以外的属性，
        // 如果app中还有第二个参数数组中没有的Symbol属性，且该Symbol属性的值是可枚举的，则这样的属性也会返回
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 5:
                  ...
                  // _context.t0是一个函数，_a接收_context.t0()的返回值
                  _a = (0, _context3.t0)();
                  mount = _a.mount;
...
export function loadMicroApp(app, configuration, lifeCycles) {
  ...
  var memorizedLoadingFn = function memorizedLoadingFn() {
    return __awaiter(_this3, void 0, void 0, /*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
      var _ref, $$cacheLifecycleByAppName, container, parcelConfigGetterPromise, xpath, _parcelConfigGetterPromise, parcelConfigObjectGetterPromise, _xpath;

      return _regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _ref = configuration !== null && configuration !== void 0 ? configuration : frameworkConfiguration, $$cacheLifecycleByAppName = _ref.$$cacheLifecycleByAppName;
